...
if (databaseUrl) {
  // Production: Use DATABASE_URL (Render provides this for PostgreSQL)
  ...
  // Development: Use individual environment variables for MySQL
  console.log('🔗 Using MySQL connection for development');
